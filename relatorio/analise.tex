...
aproximação com os sinais de referência e ruidoso, destacando (com $\star$) a
configuração global vencedora, o Chebyshev~II. Nos dois regimes, o sinal filtrado
acompanha a referência: o ruído de alta frequência é removido tanto no trecho
senoidal de baixa amplitude quanto na forma de onda distorcida depois do
chaveamento, sem suavizar demais os picos e vales dos harmônicos. As quatro
aproximações dão curvas quase coincidentes nessa escala.
